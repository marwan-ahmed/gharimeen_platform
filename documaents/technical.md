...
> **البيئة التقنية المعتمدة للمشروع (بواسطة مروان أحمد):**
>
> - **المنطقة واللغة:** سامراء، العراق | واجهة باللغة العربية.
> - **قاعدة البيانات:** Neon DB (Serverless Postgres).
> - **المصادقة:** Firebase Authentication (معرفات المستخدمين `id` ستُربط بـ Firebase UID باستخدام نوع `uuid`).
> - **العملات المالية:** كافة المعاملات المالية مسجلة بـ "الدينار العراقي (IQD)".
